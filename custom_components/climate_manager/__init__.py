...
def _build_manager_config(hass: HomeAssistant, entry: ConfigEntry) -> ManagerConfig:
    ...
    return ManagerConfig(
        ...
        pre_arrival_entity=raw.get("pre_arrival_entity"),
        ...
        windows_safety_override_enabled=raw["windows_safety_override_enabled"],
        windows_safety_maximum_backoff_minutes=raw["windows_safety_maximum_backoff_minutes"],
        windows_safety_min_indoor_temperature=raw["windows_safety_min_indoor_temperature"],
        windows_safety_max_indoor_temperature=raw["windows_safety_max_indoor_temperature"],
        windows_safety_hysteresis=raw["windows_safety_hysteresis"],
