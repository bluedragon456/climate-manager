    ...
    return vol.Schema(
        {
            ...
            vol.Required(CONF_HOME_COMFORT_TARGET, default=defaults[CONF_HOME_COMFORT_TARGET]): _float_box(defaults[CONF_HOME_COMFORT_TARGET], min_value=30, max_value=100),
            vol.Required(CONF_SLEEP_COMFORT_TARGET, default=defaults[CONF_SLEEP_COMFORT_TARGET]): _float_box(defaults[CONF_SLEEP_COMFORT_TARGET], min_value=30, max_value=100),
            vol.Required(CONF_GUEST_COMFORT_TARGET, default=defaults[CONF_GUEST_COMFORT_TARGET]): _float_box(defaults[CONF_GUEST_COMFORT_TARGET], min_value=30, max_value=100),
