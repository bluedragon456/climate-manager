    ...
    return vol.Schema(
        {
            ...
            vol.Required(CONF_COOL_CURVE_BAND_1_MIN, default=defaults[CONF_COOL_CURVE_BAND_1_MIN]): _float_box(defaults[CONF_COOL_CURVE_BAND_1_MIN], min_value=-50, max_value=150),
            ...
            vol.Required(CONF_COOL_CURVE_BAND_2_MIN, default=defaults[CONF_COOL_CURVE_BAND_2_MIN]): _float_box(defaults[CONF_COOL_CURVE_BAND_2_MIN], min_value=-50, max_value=150),
            ...
            vol.Required(CONF_COOL_CURVE_BAND_3_MIN, default=defaults[CONF_COOL_CURVE_BAND_3_MIN]): _float_box(defaults[CONF_COOL_CURVE_BAND_3_MIN], min_value=-50, max_value=150),
            ...
            vol.Required(CONF_COOL_CURVE_BAND_4_MIN, default=defaults[CONF_COOL_CURVE_BAND_4_MIN]): _float_box(defaults[CONF_COOL_CURVE_BAND_4_MIN], min_value=-50, max_value=150),
